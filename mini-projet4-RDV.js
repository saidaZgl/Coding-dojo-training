/* Projet mini : Valider un rendez-vous 
Utilisation d'une fonction pour pouvoir calculer si un RDV est possible ou pas
et l'heure de fin du RDV à partir de données variables 
*/
...
function validerRdv(
  ...
  if (finRdvMinutes < 10) {
    if (rdvOk) {
      console.log(
        duree +
          " min, RDV OK, Le RDV se terminera à " +
          finRdvHeures +
          "h0" +
          finRdvMinutes
      );
      ...
      console.log(
        duree +
          " min, RDV Impossible, Le RDV se terminera à " +
          finRdvHeures +
          "h0" +
          finRdvMinutes
      );
